...
def winFind():
	...
	if site2find not in (""):
		...
		if antislovo2find not in (""):
			...
			webbrowser.open(url)
# ПОИСК ЛЮДЕЙ (ближайщие три дня, на тот бред внизу просьба не смотреть)
def winPeople():

    print("(1)Друзья  (2)Новости  (3)Сообщества  (4)Аудиозаписи/n (5)Видеозаписи (6)Маркеры  (7)Поиск через поисковик  (8)назад")
